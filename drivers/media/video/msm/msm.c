...
/* LGE_CHANGE_S, Fixed that kernel crash is occurred when FlashLight app is working first after FlashLight app is installed, 2012-12-20 yousung.kang@lge.com */
	...
	config_cam->p_mctl =
		msm_camera_get_mctl(g_server_dev.pcam_active->mctl_handle);
#endif
/* LGE_CHANGE_E, Fixed that kernel crash is occurred when FlashLight app is working first after FlashLight app is installed, 2012-12-20 yousung.kang@lge.com */
